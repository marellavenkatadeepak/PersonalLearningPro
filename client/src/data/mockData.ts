...
export const mockMessages: Record<string, Message[]> = {
  ...
  'ann-school': [
    {
      ...
      type: 'announcement', content: '📢 Annual Sports Day will be held on March 15th. All students must report to the ground by 8:00 AM. Wear house colors.',
    ...
    },
    {
      ...
      type: 'announcement', content: '📚 Library books must be returned by Friday. Late returns will incur a fine of ₹5 per day.',
  ...
  'class-math': [
    ...
    },
    {
      ...
      type: 'doubt', content: 'Ma\'am, I\'m confused about the discriminant formula. When b²-4ac < 0, there are no real roots right?',
    ...
    },
    {
      ...
      type: 'text', content: 'Exactly right, Riya! When the discriminant is negative, the quadratic has no real roots — only complex/imaginary roots. Great question! ✅',
    ...
    },
    {
      ...
      type: 'text', content: 'Either works! But formula is faster for that one 😊',
  ...
  'dm-teacher-math': [
    ...
    },
    {
      ...
      type: 'text', content: 'Of course, Aarav. You can submit by Monday. Good luck at the tournament! 🏆',
    ...
    },
    {
      ...
      type: 'text', content: 'Thank you so much, Ma\'am! 🙏',
  ...
  'dm-friend-riya': [
    ...
    },
    {
      ...
      type: 'text', content: 'Same 😅 Let\'s ask in the class group',
